...
const CharityForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await addDoc(collection(db, "Charity"), {name:formData.name,date:formData.date,cause:formData.cause,amount:formData.amount,description:formData.description,photoUrl:uploadedUrl});
    setLoading(false);
    openModal();
  };

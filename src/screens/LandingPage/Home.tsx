...
const Home: React.FC = () => {
  ...
  return (
    <header id="home" className="w-full h-screen max-sm:h-[75vh] pt-20 max-sm:pt-28 bg-rainbow bg-no-repeat bg-auto bg-right relative text-left max-sm:bg-contain max-sm:px-4">

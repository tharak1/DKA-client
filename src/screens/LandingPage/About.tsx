  ...
  return (
    <div id="about">
      <section className="p-24 max-sm:p-5 w-full">
        ...
        <p className="mt-10 px-5 md:px-20 text-xl max-sm:text-base font-poppins">
      ...
      <section className="px-10 py-20  bg-[#C7DDFF] w-full">
        <div className="max-w-7xl mx-auto flex flex-wrap">
          ...
          <div className="w-full md:w-1/2 grid grid-cols-2 grid-rows-3 gap-4">
            <div className="p-4 flex flex-col items-center justify-center" ref={refStudents}>
              {inViewStudents && <CountUp className="text-5xl font-bold" end={550} duration={3} />}
              <p>Students</p>
            </div>
            <div className="p-4 flex flex-col items-center justify-center" ref={refTutors}>
              {inViewTutors && <CountUp className="text-5xl font-bold" end={50} duration={3} />}
              <p>Tutors</p>
            </div>
            <div className="p-4 flex flex-col items-center justify-center" ref={refIntlStudents}>
              {inViewIntlStudents && <CountUp className="text-5xl font-bold" end={110} duration={3} />}
              <p>International Students</p>
            </div>
            <div className="p-4 flex flex-col items-center justify-center" ref={refExperience}>
              {inViewExperience && <CountUp className="text-5xl font-bold" end={10} duration={3} />}
              <p>Years Of Experience</p>
            </div>
            <div className="p-4 flex flex-col items-center justify-center" ref={refPassPercentage}>
              {inViewPassPercentage && <CountUp className="text-5xl font-bold" end={98} suffix="%" duration={3} />}
              <p>Pass Percentage</p>
            </div>
            <div className="p-4 flex flex-col items-center justify-center" ref={refNationals}>

...
const Home: React.FC = () => {
  return (
    <header id="home" className="w-full bg-white p-5 md:p-20 relative text-left">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-xl md:text-2xl mb-8 whitespace-pre-line">
          {`It's a Big World\nOut There, Go\nExplore.`}
        </h2>
        ...
        <div className="relative mt-10">
          ...
          <h3 className="relative text-xl md:text-2xl font-bold bg-white px-4 mx-auto w-max z-10 mt-5">
            ABOUT DKA
          </h3>
        </div>

        <p className="mt-10 px-5 md:px-20 text-sm md:text-base">
